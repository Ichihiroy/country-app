...
function Nav({ data }) {
  ...
  return (
    <>
      <nav className="p-4 dark:bg-gray-700 dark:text-gray-100">
        <div className="container flex justify-between h-16 mx-auto">
          <div className="flex">
            ...
            >
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 32 32"
                className="w-8 h-8 dark:text-violet-600  text-orange-500"
              >
          ...
          <div className="items-center flex-shrink-0 hidden lg:flex">
            {!isDark ? (
              <button
                className="px-8 py-3 font-semibold rounded dark:text-gray-800"
